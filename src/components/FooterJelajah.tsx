    ...
    <footer className="bg-primary p-5 flex flex-col gap-3 rounded-t-[8px]" aria-label="Footer">
      <div className="flex flex-col md:flex-row gap-10 xl:gap-[252px] items-start md:px-20">
        ...
        <div className="flex flex-col gap-2">
          <p className="font-sans text-[11px] text-accent leading-[1.6]">Navigasi</p>
        ...
        <div className="flex flex-col gap-[7px]">
          <p className="font-sans text-[11px] text-accent leading-[1.6]">Kontak</p>
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="font-sans text-[11px] text-[#bfbfbf] leading-[1.6]">Versi 1.0</span>
      </div>
    </footer>
  );
}
