...
const NAV_LINKS = [
  ...
  { href: "/profil-desa", label: "Profil Desa", id: "profil-desa" },
  { href: "/infografis", label: "Infografis", id: "infografis" },
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-primary flex items-center py-[18px]">
        <div className="w-full flex items-center justify-between px-12">
          <Link
            ...
            aria-label="Desa Balerejo — beranda"
          >
            Desa Balerejo
          </Link>
      ...
      <div
        ...
        className={`fixed inset-x-0 top-[65px] z-40 bg-primary md:hidden transition-all duration-200 ease-in-out ${isOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
      >
