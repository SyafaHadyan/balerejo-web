...
export const PRODUCTS: Product[] = [
  {
    ...
    lat: Number(process.env.NEXT_PUBLIC_UMKM_LOC_1_LAT ?? "-8.2588"),
    lng: Number(process.env.NEXT_PUBLIC_UMKM_LOC_1_LNG ?? "112.2912"),
  },
  {
    ...
    lat: Number(process.env.NEXT_PUBLIC_UMKM_LOC_2_LAT ?? "-8.2615"),
    lng: Number(process.env.NEXT_PUBLIC_UMKM_LOC_2_LNG ?? "112.2888"),
  },
  {
    ...
    lat: Number(process.env.NEXT_PUBLIC_UMKM_LOC_3_LAT ?? "-8.2645"),
    lng: Number(process.env.NEXT_PUBLIC_UMKM_LOC_3_LNG ?? "112.2935"),
  },
  {
    ...
    lat: Number(process.env.NEXT_PUBLIC_UMKM_LOC_4_LAT ?? "-8.2562"),
    lng: Number(process.env.NEXT_PUBLIC_UMKM_LOC_4_LNG ?? "112.2958"),
  },
  {
    ...
    address: "Desa Balerejo, Kec. Panggungrejo, Kab. Blitar",
    image: "/images/umkm-desa.jpg",
    lat: Number(process.env.NEXT_PUBLIC_UMKM_LOC_5_LAT ?? "-8.2698"),
    lng: Number(process.env.NEXT_PUBLIC_UMKM_LOC_5_LNG ?? "112.2905"),
  },
  {
    ...
    address: "Dusun Krajan, Desa Balerejo, Kec. Panggungrejo, Kab. Blitar",
    image: "/images/makanan-khas-desa.jpg",
    lat: Number(process.env.NEXT_PUBLIC_UMKM_LOC_6_LAT ?? "-8.2720"),
    lng: Number(process.env.NEXT_PUBLIC_UMKM_LOC_6_LNG ?? "112.2872"),
  },
];
